...
<main>
	...
	<div class="container">
		...
		<h3>Results</h3>
		<p><b><i><small>These results can be visualized via the maps page</small></i></b></p>
		<hr class="hrbar">
		<div id="tpop"class="row">
